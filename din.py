...
for xd in range(10000):
	...
	c='HUAWEI BLN-L24 Build/HUAWEIBLN-L24)'
	...
	l='Chrome/62.0.3202.84 Mobile Safari/537.36'
	uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
	ugen.append(uaku2)
for x in range(10):
	a='Mozilla/5.0 (Linux; U;'
	...
	i='Android 2.3.5; en-us; vivo Y1 Build/GRJ90)'
...
def crack(idf,pwv):
	...
	sys.stdout.flush()
	ua = random.choice(['Mozilla/5.0 (Linux; Android 5.1.1; SAMSUNG SM-G920P Build/LMY47X) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/3.2 Chrome/38.0.2125.102 Mobile Safari/E7FBAF',
	...
	'Mozilla/5.0 (Linux; Android 11; SAMSUNG SM-A826S) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/18.0 Chrome/99.0.4844.88 Mobile Safari/537.36'])
...
def ceker(idf,pw):
	global cp
	ua = 'Mozilla/5.0 (Linux; Android 13; SM-F926B) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/109.0.0.0 Safari/537.36'
